  ...
  products: [
    {
      ...
      images: [
        "./assets/images/product/fashion/18-1.png",
        "./assets/images/product/fashion/18-2.png",
      ],
      price: 28.0,
      original_price: 36.0,
      sale_percentage: -22,
      ...
      colors: [
        {
          name: "green",
          image: "./assets/images/product/color/green.png",
        },
        {
          name: "red",
          image: "./assets/images/product/color/red.png",
        },
        {
          name: "yellow",
          image: "./assets/images/product/color/yellow.png",
        },
        {
          name: "purple",
          image: "./assets/images/product/color/purple.png",
        },
      ],
    ...
    },
    {
      ...
      images: [
        "./assets/images/product/fashion/8-1.png",
        "./assets/images/product/fashion/8-2.png",
      ],
      price: 24.0,
      original_price: 32.0,
      sale_percentage: -25,
    ...
    },
    {
      ...
      images: [
        "./assets/images/product/fashion/19-1.png",
        "./assets/images/product/fashion/19-2.png",
      ],
      price: 32.0,
      original_price: 40.0,
      sale_percentage: -20,
    ...
    },
    {
      ...
      name: "Off-the-Shoulder Blouse",
      images: [
        "./assets/images/product/fashion/16-2.png",
        "./assets/images/product/fashion/16-3.png",
      ],
      price: 32.0,
      original_price: 40.0,
      sale_percentage: -20,
    ...
    },
    {
      ...
      images: [
        "./assets/images/product/fashion/21-2.png",
        "./assets/images/product/fashion/21-1.png",
      ],
      price: 24.0,
      original_price: 29.0,
      sale_percentage: -17,
    ...
    },
    {
      ...
      name: "Mesh Shirt",
      images: [
        "./assets/images/product/fashion/13-1.png",
        "./assets/images/product/fashion/13-2.png",
      ],
      price: 35.0,
      original_price: 45.0,
      sale_percentage: -22,
                              ...
                              <div className="product-sold sm:pb-4 pb-2">
                                ...
                                <div className="flex items-center justify-between gap-3 gap-y-1 flex-wrap mt-2">
                                  <div className="text-button-uppercase">
                                    ...
                                    <span className="max-sm:text-xs">{xyz.sold}</span>
                                  </div>
                                  <div className="text-button-uppercase">
                                    <span className="text-secondary2 max-sm:text-xs">
                                      Available:
                                    </span>
                                    <span className="max-sm:text-xs">{xyz.available}</span>
                                  </div>
                                </div>
                              </div>
